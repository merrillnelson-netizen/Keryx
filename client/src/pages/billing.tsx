...
const TIER_FEATURES = {
  free: [
    ...
    { label: "Morning briefings", included: false },
    { label: "Personal news feed", included: false },
    { label: "Pattern alerts", included: false },
  ...
  pro: [
    ...
    { label: "Morning briefings", included: true },
    { label: "Personal news feed", included: true },
    { label: "Pattern alerts", included: true },
    { label: "Personal insights", included: true },
    ...
    { label: "SMS + location import", included: false },
  ],
  life_os: [
    ...
    { label: "SMS + location import", included: true },
  ],
};
