...
const TIER_FEATURES = {
  free: [
    ...
    { label: "Semantic AI search", included: false },
    { label: "Keryx Chat", included: false },
    { label: "AI Profile observations", included: false },
    { label: "Morning briefings & news feed", included: false },
    { label: "Personal insights", included: false },
    { label: "Goals, reminders & ideas", included: false },
    { label: "Calendar & email integration", included: false },
    { label: "People AI search & duplicate detection", included: false },
    { label: "Automation rules", included: false },
    { label: "AI Agent (autonomous actions)", included: false },
    { label: "Messages & location import", included: false },
    { label: "Universal Relay + Android Bridge", included: false },
    { label: "Meta Glasses companion", included: false },
  ],
  pro: [
    ...
    { label: "AI Agent (autonomous actions)", included: false },
    { label: "Messages sync (SMS/MMS/RCS)", included: false },
    { label: "Location intelligence", included: false },
    { label: "Universal Relay + Android Bridge", included: false },
    { label: "Meta Glasses companion", included: false },
    { label: "Financial insights (Plaid)", included: false },
    { label: "Contextual Discoveries (Tavily)", included: false },
  ],
  life_os: [
